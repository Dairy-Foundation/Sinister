...
import dev.frozenmilk.sinister.apphooks.WebHandlerRegistrarScanner.CALLSITE.webHandlerRegistrar
...
object WebHandlerRegistrarScanner : AppHookScanner<WebHandlerRegistrar>() {
	...
	private object CALLSITE {
		init {
			RobotLog.dd("WebHandlerRegistrar", "<clinit>()V")
			javaClass.getDeclaredMethod("webHandlerRegistrar", Context::class.java).let {
